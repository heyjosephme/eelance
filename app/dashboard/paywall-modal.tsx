...
export function PaywallModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="animate-fade-in-up relative w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl">
        {/* Header gradient */}
            ...
            <div className="relative flex items-start justify-between">
              ...
              <div className="text-right">
                <p className="text-2xl font-bold">
                  $9<span className="text-sm font-normal text-muted-foreground">.99/mo</span>
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Top 5 matches &middot; Basic scoring &middot; Apply to positions
                </p>
              </div>
